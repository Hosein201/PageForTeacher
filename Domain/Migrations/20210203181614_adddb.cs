        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TypeImg = table.Column<int>(nullable: false),
                    UserId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PathImgs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PathImgs_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RegisterDate = table.Column<DateTime>(nullable: false),
                    Dcs = table.Column<string>(nullable: true),
                    UserId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RegisterDate = table.Column<DateTime>(nullable: false),
                    IsLock = table.Column<bool>(nullable: false),
                    CountEdu = table.Column<int>(nullable: false),
                    UserId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CountEdu = table.Column<int>(nullable: false),
                    IsLock = table.Column<bool>(nullable: false),
                    TeachingExperience = table.Column<int>(nullable: false),
                    Age = table.Column<int>(nullable: false),
                    EducationalBackground = table.Column<int>(nullable: false),
                    UserId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Edus", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Edus_Fields_FieldId",
                        column: x => x.FieldId,
                        principalTable: "Fields",
                        principalColumn: "Code");
                    table.ForeignKey(
                        name: "FK_Edus_Students_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Students",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Edus_Teachers_TeacherId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Edus_FieldId",
                table: "Edus",
                column: "FieldId");

            migrationBuilder.CreateIndex(
                name: "IX_Edus_StudentId",
                table: "Edus",
                column: "StudentId");

            migrationBuilder.CreateIndex(
                name: "IX_Edus_TeacherId",
                table: "Edus",
                column: "TeacherId");
