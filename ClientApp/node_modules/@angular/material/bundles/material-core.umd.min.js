...
/**
     ...
     */var d,h,g=new e.Version("11.0.4");
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */(j=function j(){}).decorators=[{type:e.NgModule,args:[{imports:[c.PlatformModule],providers:[{provide:M,useClass:P}]}]}];var L,V=N;(L=function L(){}).decorators=[{type:e.NgModule,args:[{imports:[j],providers:[{provide:w,useValue:V}]}]}];
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
t.AnimationCurves=d,t.AnimationDurations=h,t.DateAdapter=M,t.ErrorStateMatcher=U,t.MATERIAL_SANITY_CHECKS=y,t.MAT_DATE_FORMATS=w,t.MAT_DATE_LOCALE=O,t.MAT_DATE_LOCALE_FACTORY=C,t.MAT_NATIVE_DATE_FORMATS=N,t.MAT_OPTGROUP=ot,t.MAT_OPTION_PARENT_COMPONENT=lt,t.MAT_RIPPLE_GLOBAL_OPTIONS=Q,t.MatCommonModule=_,t.MatLine=Y,t.MatLineModule=z,t.MatNativeDateModule=L,t.MatOptgroup=at,t.MatOption=dt,t.MatOptionModule=ut,t.MatOptionSelectionChange=ct,t.MatPseudoCheckbox=H,t.MatPseudoCheckboxModule=Z,t.MatRipple=tt,t.MatRippleModule=B,t.NativeDateAdapter=P,t.NativeDateModule=j,t.RippleRef=q,t.RippleRenderer=$,t.ShowOnDirtyErrorStateMatcher=F,t.VERSION=g,t._MatOptgroupBase=rt,t._MatOptionBase=pt,t._countGroupLabelsBeforeOption=function ht(t,e,n){if(n.length){for(var i=e.toArray(),r=n.toArray(),o=0,a=0;a<t+1;a++)i[a].group&&i[a].group===r[o]&&o++;return o}return 0},t._getOptionScrollPosition=function gt(t,e,n,i){return t<n?t:t+e>n+i?Math.max(0,t-i+e):n}
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
